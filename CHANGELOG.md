...
## Unreleased
[unreleased]: https://github.com/infolektuell/gradle-jpackage/compare/v0.1.0...HEAD
...
- Pass-through CLI options in JpackageTask were removed and replaced with documentation comments.
